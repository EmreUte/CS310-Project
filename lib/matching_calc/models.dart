...
class Driver {
  ...
  factory Driver.fromUserDoc(String id, Map<String, dynamic> data) {
    ...
    return Driver(
      ...
      gender:             _genderPrefToInt(d['passenger_gender']),
      rating:             _safeInt(d['passenger_rating']),
...
class Passenger {
  ...
  factory Passenger.fromUserDoc(String id, Map<String, dynamic> data) {
    ...
    return Passenger(
      ...
      gender:                   _genderPrefToInt(p['gender_preference']),
      smokingPreference:        _smokePrefToInt(p['smoking_preference']),
      rating:                   _safeInt(p['passenger_rating']),
      driverGenderPreference:   _genderPrefToInt(p['driver_gender_preference']),
